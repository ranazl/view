      ...
      <View style={styles.container}>
          ...
          <View style={!this.state.small ? styles.headerUp : styles.header}>
            ...
            <TouchableOpacity onPress={this.small}><Text>DOKME</Text></TouchableOpacity>
              ...
              >
              <TouchableOpacity onPress={this.changeButton1}style={this.state.btn1 ? styles.buttonOn : styles.buttonOff}>
                {this.state.btn1 && <View>
                    <View>
              ...
              <TouchableOpacity onPress={this.changeButton2}style={this.state.btn2 ? styles.buttonOn : styles.buttonOff}>
                {this.state.btn2 && <View>
                    <View>
              ...
              <TouchableOpacity onPress={this.changeButton3}style={this.state.btn3 ? styles.buttonOn : styles.buttonOff}>
                {this.state.btn3 && <View>
                    <View>
            ...
            {!this.state.small && 
            <View style={{width:dimWidth,height: dimHeight,borderRadius: 20}}>
                <TouchableOpacity onPress={this.small}><Text>DOKME</Text>
